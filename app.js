...
function getRandomImage(keyword,count){
   ...
   let requestUrl = `https://api.unsplash.com/photos/random/?count=${count}&client_id=pgfqGDDlT3GRbACGKYp_HomshUP3Cs-3qOKtOLE4NNU&featured=true&orientation=landscape&query=${keyword}`
...
//    }
//    let requestUrl = `https://api.unsplash.com/photos/random/?client_id=pgfqGDDlT3GRbACGKYp_HomshUP3Cs-3qOKtOLE4NNU&featured=true&orientation=landscape&query=${keyword}`
